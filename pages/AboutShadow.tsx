...
const AboutShadow: React.FC = () => {
  return (
    <main className="pt-32 pb-32 px-6 overflow-hidden bg-gradient-to-b from-neutral-50 to-white">
      <div className="max-w-7xl mx-auto space-y-36">

        {/* ================= ABOUT HERO ================= */}
        <section className="relative h-[90vh] flex items-center justify-center overflow-hidden rounded-[3rem] shadow-2xl">
          <div
