        ...
        <div className="grid md:grid-cols-4 gap-12 mb-20">
          ...
          <div className="col-span-2 space-y-8">
            ...
            <div className="flex gap-4">
              <a className="group p-3 bg-white/10 rounded-full hover:bg-pleo-blue transition-all duration-300 hover:scale-110">
                <Facebook className="w-5 h-5 group-hover:text-white" />
              </a>
              <a className="group p-3 bg-white/10 rounded-full hover:bg-red-600 transition-all duration-300 hover:scale-110">
                <Youtube className="w-5 h-5 group-hover:text-white" />
              </a>
              <a className="group p-3 bg-white/10 rounded-full hover:bg-pink-600 transition-all duration-300 hover:scale-110">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3 text-white/60 text-sm">
              <li><a className="flex items-center gap-2 hover:text-white hover:translate-x-1 transition-all"><Home className="w-3 h-3" /> Home</a></li>
              <li><a className="flex items-center gap-2 hover:text-white hover:translate-x-1 transition-all"><Users className="w-3 h-3" /> About Us</a></li>
              <li><a className="flex items-center gap-2 hover:text-white hover:translate-x-1 transition-all"><Briefcase className="w-3 h-3" /> Projects</a></li>
              <li><a className="flex items-center gap-2 hover:text-white hover:translate-x-1 transition-all"><Camera className="w-3 h-3" /> Gallery</a></li>
              <li><a className="flex items-center gap-2 hover:text-white hover:translate-x-1 transition-all"><Mail className="w-3 h-3" /> Contact</a></li>
            </ul>
